    ...
    <div style={{width:'150px',display:'flex',alignItems:'center',justifyContent:"left",padding:'0px'}}>
      ...
      <p style={{marginLeft:'15px'}}>{coin[Object.keys(coin)]['name']}</p>
       ...
       <div className= 'tableright'><p className='symbol'>{coin[Object.keys(coin)]['symbol']}</p>
            ...
            <div style={{minWidth:'55px',width:'20%',display:'flex',alignItems:'center',justifyContent:'center',color:colorvote}}><div style={{width:'55px',height:"30px",padding:'4px',borderRadius:'10px',border:'2px solid grey',backgroundColor:'transparent'}}><p style={{display:'flex',alignItems:'center',justifyContent:'center'}} onClick={StarClick}>{arrowforvote}</p>
