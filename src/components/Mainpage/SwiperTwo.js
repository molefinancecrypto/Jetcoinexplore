...
function SwiperTwo() {
  ...
  {CoinObj.slice(4,8).map(val => <div key={uuidv4()} style={{display:'flex',justifyContent:'space-around',backgroundColor:'white',color:'black',width:"220px",height:'65px',marginTop:'15px',borderRadius:'10px',marginLeft:'7.5px',marginRight:'7.5px',padding:'7px',boxSizing:"border-box"}}>
