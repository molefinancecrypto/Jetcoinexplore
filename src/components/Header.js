...
function Header() {
  ...
  <div className = 'searchholder' >
     <div ref={menuref} style={{width:'100%',height:"30px",position:'relative'}}>
        <input onClick={rolldownsearch} onChange={changeSearch} type='search' value={searchvalue} style={{width:'100%',height:'100%',outline:'none',color:'white', borderRadius:'9px',backgroundColor:'rgb(6, 16, 28)'}}/>
