  ...
  return <div className='listCoinMain'>
            ...
            <div style={{height:'80%',width:'90%',margin:'20px auto',border:'1px solid #112836',backgroundColor:'#071323',borderRadius:'7px',padding:'20px',boxSizing:'border-box'}}>
                ...
                <div style={{width:'100%',height:'50vh',marginTop:'40px',position:'relative',display:sliderposition['contracts']}}>
                    ...
                    <div style={{position:'absolute',bottom:'20px',left:'5%',width:'90%',display:'flex',justifyContent:'space-between',margin:'0px auto',color:'white'}}>
                        <button onClick={info} style={{width:'150px',height:'40px',backgroundColor:'#02050a',outline:'none',border:'2px solid #02050a',borderRadius:'5px',color:'white'}}>Back</button>
                        <button onClick={links} style={{width:'150px',height:'40px',backgroundColor:'#02050a',outline:'none',border:'2px solid #02050a',borderRadius:'5px',color:'white'}}>Continue</button>
                    </div>
                </div>
                ...
                <div style={{width:'100%',height:'50vh',marginTop:'40px',position:'relative',display:sliderposition['Link']}}>
                    ...
                    <div style={{position:'absolute',bottom:'20px',left:'5%',width:'90%',display:'flex',justifyContent:'space-between',margin:'0px auto',color:'white'}}>
                        <button onClick={contracts} style={{width:'150px',height:'40px',backgroundColor:'#02050a',outline:'none',border:'2px solid #02050a',borderRadius:'5px',color:'white'}}>Back</button>
                        <button onClick={addons} style={{width:'150px',height:'40px',backgroundColor:'#02050a',outline:'none',border:'2px solid #02050a',borderRadius:'5px',color:'white'}}>Continue</button>
                    </div>
                </div>
                ...
                <div style={{width:'100%',height:'50vh',marginTop:'40px',position:'relative',display:sliderposition['addons']}}>
                    ...
                    <div style={{position:'absolute',bottom:'20px',left:'5%',width:'90%',display:'flex',justifyContent:'space-between',margin:'0px auto',color:'white'}}>
                        <button onClick={links} style={{width:'150px',height:'40px',backgroundColor:'#02050a',outline:'none',border:'2px solid #02050a',borderRadius:'5px',color:'white'}}>Back</button>
                        <button  style={{width:'150px',height:'40px',backgroundColor:'#02050a',outline:'none',border:'2px solid #02050a',borderRadius:'5px',color:'white'}}>Add Coin</button>
                    </div>
                </div>
            </div>
