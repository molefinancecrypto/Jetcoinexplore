...
//useEffect for cost calculation
  ...
  return (
    <div style={{width:'90%',minHeight:'100vh',fontSize:overallwidth>900?'18px':'13px',color:'white',padding:overallwidth>900?'30px':'15px',boxSizing:'border-box',backgroundColor:'#071323',borderRadius:'20px',margin:'30px auto',border:'2px solid #0B1F36'}}>
        ...
        <p style={{textAlign:'center',fontSize:overallwidth>900?'37px':'25px',letterSpacing:'1.5px',margin:'20px 0px',color:'white'}}>Promotion</p>
