  ...
  return (
    <div style={{paddingTop:'30px',color:'white',width:'100%',height:'100%',display:'flex',flexDirection:'column',justifyContent:'space-between',boxSizing:'border-box'}}>
        <div style={{height:'35%'}}>
            ...
            <p style={{fontSize:'25px',letterSpacing:'1.5px'}}>{data.name}</p>
        ...
        <div style={{height:'40%',marginBottom:'35px',display:'flex',justifyContent:'space-around',flexDirection:"column"}}>
            <div>
                ...
                <p style={{textAlign:'left',paddingLeft:'15px'}}>{data.telegram}</p>
            </div>
            <div>
                <p style={{textAlign:'left',paddingLeft:'15px'}}><strong>E-mail:</strong></p>
                <p style={{textAlign:'left',paddingLeft:'15px'}}>{data.mail}</p>
            </div>
        </div>
    </div>
  )
